...
describe('Component OrderOption', () => {
  it ('should render without crashing', () => {
    const component = shallow(<OrderOption name='Lorem ipsum' type='Lorem ipsum' />);
      ...
      switch (type) {
        ...
        case 'icons': {
          it('contains div with class icon', () => {
            ...
            expect(icon.find('Icon')).toBeTruthy();
          });
          it('should run setOrderOption function on change', () => {
        ...
        case 'date': {
          ...
          it('should run seontOrderOption function on change', () => {
